...
return [
  ...
  'helloasso_partner_authorize_url_live' => [
    'name' => 'helloasso_partner_authorize_url_live',
    'type' => 'String',
    'html_type' => 'text',
    'default' => 'https://auth.helloasso.com/authorize',
    'is_domain' => 1,
  ...
  'helloasso_partner_authorize_url_test' => [
    'name' => 'helloasso_partner_authorize_url_test',
    'type' => 'String',
    'html_type' => 'text',
    'default' => 'https://auth.helloasso-sandbox.com/authorize',
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => E::ts("HelloAsso authorization screen: authorization URL"),
    'description' => E::ts("HelloAsso authorization screen URL for sandbox mode."),
    'html_attributes' => ['size' => 64],
  ],
  ...
  'helloasso_partner_token_url_live' => [
    'name' => 'helloasso_partner_token_url_live',
    'type' => 'String',
    'html_type' => 'text',
    'default' => 'https://api.helloasso.com/oauth2/token',
    'is_domain' => 1,
  ...
  'helloasso_partner_token_url_test' => [
    'name' => 'helloasso_partner_token_url_test',
    'type' => 'String',
    'html_type' => 'text',
    'default' => 'https://api.helloasso-sandbox.com/oauth2/token',
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => E::ts('HelloAsso authorization screen: token URL'),
    'description' => E::ts("HelloAsso endpoint used to exchange the authorization code and refresh OAuth tokens for sandbox mode."),
    'html_attributes' => ['size' => 64],
  ],
];
